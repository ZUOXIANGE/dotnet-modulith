...
public static class PermissionCodes
{
    ...
    public const string MemberGroupsManage = "members.groups.manage";
    public const string BorrowingOperate = "borrowing.operate";
    public const string BorrowingView = "borrowing.view";
    public const string BorrowingRules = "borrowing.rules";
    ...
    public const string FinesRules = "fines.rules";
