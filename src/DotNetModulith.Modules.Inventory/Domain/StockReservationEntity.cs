...
public sealed class StockReservationEntity
{
    ...
    /// 创建新的库存预留明细
    /// </summary>
    public static StockReservationEntity Create(StockId stockId, string orderId, string productId, int quantity)
    {
        if (string.IsNullOrWhiteSpace(orderId))
            throw new ArgumentException("OrderEntity ID is required.", nameof(orderId));
